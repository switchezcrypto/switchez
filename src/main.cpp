...
const string strMessageMagic = "switchez Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    if(pindexBest->nHeight < 20) // SWZ
    {
        nSubsidy = 20000000 * COIN;
    }
    else if(pindexBest->nHeight < 900000) // backup
    {
        nSubsidy = 1 * COIN;
    }
...
// switchez: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "switchez", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "SWZ genesis";
        CTransaction txNew;
        txNew.nTime = 1572027720;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x2e071db697d364eee17551b5a56286f0b8529abda817c0a3eb8b297d42833092"));
        block.print();
